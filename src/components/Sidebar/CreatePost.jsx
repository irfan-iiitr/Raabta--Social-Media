...
function useCreatePost() {
	...
	const userProfileFromStore = useUserProfileStore((state) => state.userProfile);

var userProfile;
// if(pathname ==='/')
//   userProfile=authUser;
// else
  userProfile = userProfileFromStore;
	...
	const handleCreatePost = async (selectedFile, caption) => {
		...
		try {
			...
			if(pathname===`/${authUser.username}` &&  authUser.uid===userProfile.uid)
